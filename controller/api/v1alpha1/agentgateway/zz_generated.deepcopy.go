...
func (in *OAuth2) DeepCopyInto(out *OAuth2) {
	*out = *in
	if in.ProviderBackendRef != nil {
		in, out := &in.ProviderBackendRef, &out.ProviderBackendRef
	...
	if in.AutoDetectRedirectURI != nil {
		in, out := &in.AutoDetectRedirectURI, &out.AutoDetectRedirectURI
		*out = new(bool)
		**out = **in
	}
	if in.Scopes != nil {
	...
	if in.PassThroughMatchers != nil {
		in, out := &in.PassThroughMatchers, &out.PassThroughMatchers
		*out = make([]ShortString, len(*in))
		copy(*out, *in)
	}
	if in.DenyRedirectMatchers != nil {
		in, out := &in.DenyRedirectMatchers, &out.DenyRedirectMatchers
		*out = make([]ShortString, len(*in))
		copy(*out, *in)
	}
	...
	if in.RefreshableCookieMaxAgeSeconds != nil {
		in, out := &in.RefreshableCookieMaxAgeSeconds, &out.RefreshableCookieMaxAgeSeconds
		*out = new(uint64)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OIDCJWKS) DeepCopyInto(out *OIDCJWKS) {
	*out = *in
	if in.ProviderBackendRef != nil {
		in, out := &in.ProviderBackendRef, &out.ProviderBackendRef
		*out = new(apisv1.BackendObjectReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OIDCJWKS.
func (in *OIDCJWKS) DeepCopy() *OIDCJWKS {
	if in == nil {
		return nil
	}
	out := new(OIDCJWKS)
