...
|`jwt`|`jwt` contains claims from a verified JWT token or OAuth2/OIDC `id_token`.<br>This is populated only when claims are available from authentication policies.|
