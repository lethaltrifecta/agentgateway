...
func (TrafficPolicySpec_HostRewrite_Mode) EnumDescriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{44, 14, 0}
}
...
func (x *TrafficPolicySpec) GetOauth2() *TrafficPolicySpec_OAuth2 {
	if x != nil {
		if x, ok := x.Kind.(*TrafficPolicySpec_Oauth2); ok {
			return x.Oauth2
		}
	}
	return nil
...
type TrafficPolicySpec_Oauth2 struct {
	Oauth2 *TrafficPolicySpec_OAuth2 `protobuf:"bytes,22,opt,name=oauth2,proto3,oneof"`
}
...
func (*TrafficPolicySpec_Oauth2) isTrafficPolicySpec_Kind() {}
...
type TrafficPolicySpec_JWTProvider struct {
	...
	//	*TrafficPolicySpec_JWTProvider_Oidc
...
func (x *TrafficPolicySpec_JWTProvider) GetOidc() *TrafficPolicySpec_JWTProvider_OIDC {
	if x != nil {
		if x, ok := x.JwksSource.(*TrafficPolicySpec_JWTProvider_Oidc); ok {
			return x.Oidc
		}
	}
	return nil
...
type TrafficPolicySpec_JWTProvider_Oidc struct {
	// OIDC discovery-backed JWKS resolution
	Oidc *TrafficPolicySpec_JWTProvider_OIDC `protobuf:"bytes,5,opt,name=oidc,proto3,oneof"`
}

func (*TrafficPolicySpec_JWTProvider_Inline) isTrafficPolicySpec_JWTProvider_JwksSource() {}

func (*TrafficPolicySpec_JWTProvider_Oidc) isTrafficPolicySpec_JWTProvider_JwksSource() {}
...
type TrafficPolicySpec_JWT struct {
	...
	// When true, preserve Authorization after successful verification.
	// When false (default), remove Authorization after verification.
...
func (x *TrafficPolicySpec_JWT) GetForward() bool {
...
type TrafficPolicySpec_OAuth2 struct {
	...
	AllowInsecureRedirectUri          bool                   `protobuf:"varint,22,opt,name=allow_insecure_redirect_uri,json=allowInsecureRedirectUri,proto3" json:"allow_insecure_redirect_uri,omitempty"`
	unknownFields                     protoimpl.UnknownFields
	sizeCache                         protoimpl.SizeCache
}

func (x *TrafficPolicySpec_OAuth2) Reset() {
	*x = TrafficPolicySpec_OAuth2{}
	mi := &file_resource_proto_msgTypes[82]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TrafficPolicySpec_OAuth2) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrafficPolicySpec_OAuth2) ProtoMessage() {}

func (x *TrafficPolicySpec_OAuth2) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[82]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrafficPolicySpec_OAuth2.ProtoReflect.Descriptor instead.
func (*TrafficPolicySpec_OAuth2) Descriptor() ([]byte, []int) {
...
func (x *TrafficPolicySpec_OAuth2) GetProviderBackend() *BackendReference {
	if x != nil {
		return x.ProviderBackend
	}
	return nil
...
func (x *TrafficPolicySpec_OAuth2) GetClientSecret() string {
	if x != nil {
		return x.ClientSecret
	}
	return ""
...
func (x *TrafficPolicySpec_OAuth2) GetRedirectUri() string {
...
func (x *TrafficPolicySpec_OAuth2) GetCookieName() string {
...
func (x *TrafficPolicySpec_OAuth2) GetRefreshableCookieMaxAgeSeconds() uint64 {
	if x != nil && x.RefreshableCookieMaxAgeSeconds != nil {
		return *x.RefreshableCookieMaxAgeSeconds
	}
	return 0
}

func (x *TrafficPolicySpec_OAuth2) GetPostLogoutRedirectUri() string {
	if x != nil && x.PostLogoutRedirectUri != nil {
...
func (x *TrafficPolicySpec_OAuth2) GetAllowInsecureRedirectUri() bool {
	if x != nil {
		return x.AllowInsecureRedirectUri
	}
	return false
}
...
type TrafficPolicySpec_JWTProvider_OIDC struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Optional backend used for OIDC provider back-channel calls.
	ProviderBackend *BackendReference `protobuf:"bytes,1,opt,name=provider_backend,json=providerBackend,proto3" json:"provider_backend,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *TrafficPolicySpec_JWTProvider_OIDC) Reset() {
	*x = TrafficPolicySpec_JWTProvider_OIDC{}
	mi := &file_resource_proto_msgTypes[93]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TrafficPolicySpec_JWTProvider_OIDC) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TrafficPolicySpec_JWTProvider_OIDC) ProtoMessage() {}

func (x *TrafficPolicySpec_JWTProvider_OIDC) ProtoReflect() protoreflect.Message {
	mi := &file_resource_proto_msgTypes[93]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TrafficPolicySpec_JWTProvider_OIDC.ProtoReflect.Descriptor instead.
func (*TrafficPolicySpec_JWTProvider_OIDC) Descriptor() ([]byte, []int) {
	return file_resource_proto_rawDescGZIP(), []int{44, 4, 0}
}

func (x *TrafficPolicySpec_JWTProvider_OIDC) GetProviderBackend() *BackendReference {
	if x != nil {
		return x.ProviderBackend
	}
	return nil
...
const file_resource_proto_rawDesc = "" +
	...
	"\x0frequired_claims\x18\x01 \x03(\tR\x0erequiredClaims\"\xc6E\n" +
	...
	"\x06oauth2\x18\x16 \x01(\v23.agentgateway.dev.resource.TrafficPolicySpec.OAuth2H\x00R\x06oauth2\x1a\x8c\x05\n" +
	...
	"\x04deny\x18\x02 \x03(\tR\x04deny\x1a\x88\x03\n" +
	"\vJWTProvider\x12\x16\n" +
	"\x06issuer\x18\x01 \x01(\tR\x06issuer\x12\x1c\n" +
	"\taudiences\x18\x02 \x03(\tR\taudiences\x12\x18\n" +
	"\x06inline\x18\x03 \x01(\tH\x00R\x06inline\x12S\n" +
	"\x04oidc\x18\x05 \x01(\v2=.agentgateway.dev.resource.TrafficPolicySpec.JWTProvider.OIDCH\x00R\x04oidc\x12e\n" +
	"\x16jwt_validation_options\x18\x04 \x01(\v2/.agentgateway.dev.resource.JWTValidationOptionsR\x14jwtValidationOptions\x1a^\n" +
	"\x04OIDC\x12V\n" +
	"\x10provider_backend\x18\x01 \x01(\v2+.agentgateway.dev.resource.BackendReferenceR\x0fproviderBackendB\r\n" +
	"\vjwks_source\x1a\x85\x02\n" +
	"\x03JWT\x12I\n" +
	"\x04mode\x18\x01 \x01(\x0e25.agentgateway.dev.resource.TrafficPolicySpec.JWT.ModeR\x04mode\x12V\n" +
	"\tproviders\x18\x02 \x03(\v28.agentgateway.dev.resource.TrafficPolicySpec.JWTProviderR\tproviders\x12\x1d\n" +
	"\aforward\x18\x03 \x01(\bH\x00R\aforward\x88\x01\x01\"0\n" +
	"\x04Mode\x12\f\n" +
	...
	"%token_endpoint_auth_methods_supported\x18\x14 \x03(\tR!tokenEndpointAuthMethodsSupported\x12=\n" +
	"\x1ballow_insecure_redirect_uri\x18\x16 \x01(\bR\x18allowInsecureRedirectUriB\x0f\n" +
	"\r_redirect_uriB\x0e\n" +
	"\f_cookie_nameB\x10\n" +
	"\x0e_sign_out_pathB%\n" +
...
var file_resource_proto_msgTypes = make([]protoimpl.MessageInfo, 139)
var file_resource_proto_goTypes = []any{
	...
	(*TrafficPolicySpec_OAuth2)(nil),                            // 109: agentgateway.dev.resource.TrafficPolicySpec.OAuth2
	...
	(*TrafficPolicySpec_JWTProvider_OIDC)(nil),               // 120: agentgateway.dev.resource.TrafficPolicySpec.JWTProvider.OIDC
	(*TrafficPolicySpec_APIKey_User)(nil),                    // 121: agentgateway.dev.resource.TrafficPolicySpec.APIKey.User
	(*TrafficPolicySpec_TransformationPolicy_Transform)(nil), // 122: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform
...
var file_resource_proto_depIdxs = []int32{
	...
	168, // 34: agentgateway.dev.resource.Timeout.request:type_name -> google.protobuf.Duration
	168, // 35: agentgateway.dev.resource.Timeout.backend_request:type_name -> google.protobuf.Duration
	168, // 36: agentgateway.dev.resource.Retry.backoff:type_name -> google.protobuf.Duration
	...
	168, // 56: agentgateway.dev.resource.CORS.max_age:type_name -> google.protobuf.Duration
	...
	168, // 66: agentgateway.dev.resource.KeepaliveConfig.time:type_name -> google.protobuf.Duration
	168, // 67: agentgateway.dev.resource.KeepaliveConfig.interval:type_name -> google.protobuf.Duration
	...
	110, // 93: agentgateway.dev.resource.TrafficPolicySpec.host_rewrite:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HostRewrite
	109, // 94: agentgateway.dev.resource.TrafficPolicySpec.oauth2:type_name -> agentgateway.dev.resource.TrafficPolicySpec.OAuth2
	...
	164, // 108: agentgateway.dev.resource.AIBackend.provider_groups:type_name -> agentgateway.dev.resource.AIBackend.ProviderGroup
	...
	165, // 114: agentgateway.dev.resource.BackendReference.service:type_name -> agentgateway.dev.resource.BackendReference.Service
	78,  // 115: agentgateway.dev.resource.RequestMirrors.Mirror.backend:type_name -> agentgateway.dev.resource.BackendReference
	168, // 116: agentgateway.dev.resource.FrontendPolicySpec.HTTP.http1_idle_timeout:type_name -> google.protobuf.Duration
	168, // 117: agentgateway.dev.resource.FrontendPolicySpec.HTTP.http2_keepalive_interval:type_name -> google.protobuf.Duration
	168, // 118: agentgateway.dev.resource.FrontendPolicySpec.HTTP.http2_keepalive_timeout:type_name -> google.protobuf.Duration
	168, // 119: agentgateway.dev.resource.FrontendPolicySpec.TLS.handshake_timeout:type_name -> google.protobuf.Duration
	...
	168, // 134: agentgateway.dev.resource.TrafficPolicySpec.LocalRateLimit.fill_interval:type_name -> google.protobuf.Duration
	...
	168, // 141: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.timeout:type_name -> google.protobuf.Duration
	120, // 142: agentgateway.dev.resource.TrafficPolicySpec.JWTProvider.oidc:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWTProvider.OIDC
	70,  // 143: agentgateway.dev.resource.TrafficPolicySpec.JWTProvider.jwt_validation_options:type_name -> agentgateway.dev.resource.JWTValidationOptions
	11,  // 144: agentgateway.dev.resource.TrafficPolicySpec.JWT.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWT.Mode
	100, // 145: agentgateway.dev.resource.TrafficPolicySpec.JWT.providers:type_name -> agentgateway.dev.resource.TrafficPolicySpec.JWTProvider
	12,  // 146: agentgateway.dev.resource.TrafficPolicySpec.BasicAuthentication.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.BasicAuthentication.Mode
	121, // 147: agentgateway.dev.resource.TrafficPolicySpec.APIKey.api_keys:type_name -> agentgateway.dev.resource.TrafficPolicySpec.APIKey.User
	13,  // 148: agentgateway.dev.resource.TrafficPolicySpec.APIKey.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.APIKey.Mode
	122, // 149: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.request:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform
	122, // 150: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.response:type_name -> agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform
	78,  // 151: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.target:type_name -> agentgateway.dev.resource.BackendReference
	14,  // 152: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.failure_mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.FailureMode
	123, // 153: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.request_attributes:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.RequestAttributesEntry
	124, // 154: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.response_attributes:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.ResponseAttributesEntry
	126, // 155: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.metadata_context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.MetadataContextEntry
	78,  // 156: agentgateway.dev.resource.TrafficPolicySpec.OAuth2.provider_backend:type_name -> agentgateway.dev.resource.BackendReference
	15,  // 157: agentgateway.dev.resource.TrafficPolicySpec.HostRewrite.mode:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HostRewrite.Mode
	112, // 158: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor.entries:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Entry
	7,   // 159: agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Descriptor.type:type_name -> agentgateway.dev.resource.TrafficPolicySpec.RemoteRateLimit.Type
	116, // 160: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.ContextEntry
	117, // 161: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.metadata:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.GRPCProtocol.MetadataEntry
	118, // 162: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.add_request_headers:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.AddRequestHeadersEntry
	119, // 163: agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.metadata:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExternalAuth.HTTPProtocol.MetadataEntry
	78,  // 164: agentgateway.dev.resource.TrafficPolicySpec.JWTProvider.OIDC.provider_backend:type_name -> agentgateway.dev.resource.BackendReference
	169, // 165: agentgateway.dev.resource.TrafficPolicySpec.APIKey.User.metadata:type_name -> google.protobuf.Struct
	105, // 166: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.set:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	105, // 167: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.add:type_name -> agentgateway.dev.resource.TrafficPolicySpec.HeaderTransformation
	106, // 168: agentgateway.dev.resource.TrafficPolicySpec.TransformationPolicy.Transform.body:type_name -> agentgateway.dev.resource.TrafficPolicySpec.BodyTransformation
	127, // 169: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext.context:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext.ContextEntry
	125, // 170: agentgateway.dev.resource.TrafficPolicySpec.ExtProc.MetadataContextEntry.value:type_name -> agentgateway.dev.resource.TrafficPolicySpec.ExtProc.NamespacedMetadataContext
	147, // 171: agentgateway.dev.resource.BackendPolicySpec.Ai.prompt_guard:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard
	149, // 172: agentgateway.dev.resource.BackendPolicySpec.Ai.defaults:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.DefaultsEntry
	150, // 173: agentgateway.dev.resource.BackendPolicySpec.Ai.overrides:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.OverridesEntry
	151, // 174: agentgateway.dev.resource.BackendPolicySpec.Ai.transformations:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.TransformationsEntry
	137, // 175: agentgateway.dev.resource.BackendPolicySpec.Ai.prompts:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment
	152, // 176: agentgateway.dev.resource.BackendPolicySpec.Ai.model_aliases:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ModelAliasesEntry
	148, // 177: agentgateway.dev.resource.BackendPolicySpec.Ai.prompt_caching:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.PromptCaching
	153, // 178: agentgateway.dev.resource.BackendPolicySpec.Ai.routes:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RoutesEntry
	78,  // 179: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.endpoint_picker:type_name -> agentgateway.dev.resource.BackendReference
	19,  // 180: agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.failure_mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.InferenceRouting.FailureMode
	20,  // 181: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.verification:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendTLS.VerificationMode
	79,  // 182: agentgateway.dev.resource.BackendPolicySpec.BackendTLS.alpn:type_name -> agentgateway.dev.resource.Alpn
	21,  // 183: agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.version:type_name -> agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.HttpVersion
	168, // 184: agentgateway.dev.resource.BackendPolicySpec.BackendHTTP.request_timeout:type_name -> google.protobuf.Duration
	68,  // 185: agentgateway.dev.resource.BackendPolicySpec.BackendTCP.keepalive:type_name -> agentgateway.dev.resource.KeepaliveConfig
	168, // 186: agentgateway.dev.resource.BackendPolicySpec.BackendTCP.connect_timeout:type_name -> google.protobuf.Duration
	22,  // 187: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.provider:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.McpIDP
	154, // 188: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.resource_metadata:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata
	23,  // 189: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.mode:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.Mode
	70,  // 190: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.jwt_validation_options:type_name -> agentgateway.dev.resource.JWTValidationOptions
	136, // 191: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.append:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	136, // 192: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptEnrichment.prepend:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Message
	16,  // 193: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule.builtin:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BuiltinRegexRule
	17,  // 194: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.action:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ActionKind
	138, // 195: agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules.rules:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRule
	78,  // 196: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.backend:type_name -> agentgateway.dev.resource.BackendReference
	58,  // 197: agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook.forward_header_matches:type_name -> agentgateway.dev.resource.HeaderMatch
	72,  // 198: agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	72,  // 199: agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	72,  // 200: agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	144, // 201: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	139, // 202: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	140, // 203: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	143, // 204: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.google_model_armor:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	142, // 205: agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard.bedrock_guardrails:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	144, // 206: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.rejection:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestRejection
	139, // 207: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.regex:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RegexRules
	140, // 208: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.webhook:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Webhook
	141, // 209: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.openai_moderation:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.Moderation
	143, // 210: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.google_model_armor:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.GoogleModelArmor
	142, // 211: agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard.bedrock_guardrails:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.BedrockGuardrails
	146, // 212: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.request:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RequestGuard
	145, // 213: agentgateway.dev.resource.BackendPolicySpec.Ai.PromptGuard.response:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.ResponseGuard
	18,  // 214: agentgateway.dev.resource.BackendPolicySpec.Ai.RoutesEntry.value:type_name -> agentgateway.dev.resource.BackendPolicySpec.Ai.RouteType
	155, // 215: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.extra:type_name -> agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry
	170, // 216: agentgateway.dev.resource.BackendPolicySpec.McpAuthentication.ResourceMetadata.ExtraEntry.value:type_name -> google.protobuf.Value
	156, // 217: agentgateway.dev.resource.AIBackend.Provider.host_override:type_name -> agentgateway.dev.resource.AIBackend.HostOverride
	157, // 218: agentgateway.dev.resource.AIBackend.Provider.openai:type_name -> agentgateway.dev.resource.AIBackend.OpenAI
	158, // 219: agentgateway.dev.resource.AIBackend.Provider.gemini:type_name -> agentgateway.dev.resource.AIBackend.Gemini
	159, // 220: agentgateway.dev.resource.AIBackend.Provider.vertex:type_name -> agentgateway.dev.resource.AIBackend.Vertex
	160, // 221: agentgateway.dev.resource.AIBackend.Provider.anthropic:type_name -> agentgateway.dev.resource.AIBackend.Anthropic
	161, // 222: agentgateway.dev.resource.AIBackend.Provider.bedrock:type_name -> agentgateway.dev.resource.AIBackend.Bedrock
	162, // 223: agentgateway.dev.resource.AIBackend.Provider.azureopenai:type_name -> agentgateway.dev.resource.AIBackend.AzureOpenAI
	72,  // 224: agentgateway.dev.resource.AIBackend.Provider.inline_policies:type_name -> agentgateway.dev.resource.BackendPolicySpec
	163, // 225: agentgateway.dev.resource.AIBackend.ProviderGroup.providers:type_name -> agentgateway.dev.resource.AIBackend.Provider
...
func file_resource_proto_init() {
	...
	file_resource_proto_msgTypes[73].OneofWrappers = []any{
		...
		(*TrafficPolicySpec_JWTProvider_Oidc)(nil),
	}
